...
- 每位陪陪可保存付款方式、付款内容和一张付款图片（例如 TNG 二维码／截图）。图片直接存入 MongoDB，限 PNG、JPG、WebP 且 700KB 以内。
- 在订单管理的结果表中点击陪陪名称，可立即查看该陪陪的付款资料；未填写资料时会明确提示。
- “单量排行榜”已独立为 /leaderboard 页面，可查看月榜与总榜；陪陪管理只保留名单与付款资料。
